    ...
    return (
              <div className="navigation" id="nav">
                  <div className="item user">
                      <img src="images/bg_user.png" alt="" width="199" height="199" className="circle"/>
                  ...
                  <div className="item home">
                      <img src="images/bg_home.png" alt="" width="199" height="199" className="circle"/>
                      <a href="#" className="icon" />
                      <h2>Home</h2>
                      <ul>
                  ...
                  <div className="item shop">
                      <img src="images/bg_shop.png" alt="" width="199" height="199" className="circle"/>
                      <a href="#" className="icon" />
                      <h2>Shop</h2>
                      <ul>
                  ...
                  <div className="item camera">
                      <img src="images/bg_camera.png" alt="" width="199" height="199" className="circle"/>
                      <a href="#" className="icon" />
                      <h2>Photos</h2>
                      <ul>
                  ...
                  <div className="item fav">
                      <img src="images/bg_fav.png" alt="" width="199" height="199" className="circle"/>
                      <a href="#" className="icon" />
                      <h2>Love</h2>
                      <ul>
